% This file performs a parameter recovery analysis. To run this file, first
% run main.m. Then run the first section of this file. After that, you can
% run the subsequent sections of the file, changing the "w" and "threshold"
% variables to plot different parts of the recovery analysis
