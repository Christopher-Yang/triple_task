function plot_cursor_direction(data, subj_name)
...
%% raster plot of cursor direction vs target direction from one participant
...
%% heatmap of cursor direction vs target direction pooled across all participants
...
%% raster plot of cursor direction vs target direction pooled across all participants
...
%% histogram of initial cursor direction error
...
for i = 1:2
    for j = 1:2
        for k = 1:2
            ...
            if i == 2
                xlabel('Initial cursor direction error')
            end
...
%% plot initial cursor direction error to highlight pairwise comparisons
...
% print('C:\Users\Chris\Dropbox\Conferences\SFN 2022\initError','-dpdf','-painters')

%% plot path length and reach time
